...
public class LocalStack extends Stack {
    ...
    public LocalStack (final App scope, final String id, final StackProps props) {
        ...
        FargateService authService = createFargateService("AuthServic",
                "auth-service",
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET","eW91ci1sb25nLXNlY3JldC1rZXktdGhhdC1pcy1hdC1sZWFzdC0zMi1jaGFyYWN0ZXJzLWxvbmc="));
